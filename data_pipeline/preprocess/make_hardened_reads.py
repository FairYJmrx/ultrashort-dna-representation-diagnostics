"""Organized entrypoint for `scripts.make_hardened_reads`.

The implementation remains in `scripts/make_hardened_reads.py` for import compatibility.
...
if __name__ == "__main__":
    runpy.run_module("scripts.make_hardened_reads", run_name="__main__")
