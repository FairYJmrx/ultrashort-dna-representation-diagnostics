...
|   mutation_fraction | representation   |   n_cells |   noise_l2 |   local_l2 |   local_minus_noise_l2 |   n_features |   selective_sensitivity_ratio |
|--------------------:|:-----------------|----------:|-----------:|-----------:|-----------------------:|-------------:|------------------------------:|
|               0.010 | ck4              |        12 |      0.238 |      0.228 |                 -0.010 |      136.000 |                         0.959 |
|               0.010 | ck4_msp          |        12 |      0.168 |      0.162 |                 -0.007 |      211.000 |                         0.959 |
|               0.010 | ck4_p            |        12 |      0.168 |      0.161 |                 -0.007 |      147.000 |                         0.959 |
|               0.010 | ck4p_msp         |        12 |      0.138 |      0.132 |                 -0.006 |      222.000 |                         0.960 |
|               0.030 | ck4              |        12 |      0.355 |      0.266 |                 -0.089 |      136.000 |                         0.750 |
|               0.030 | ck4_msp          |        12 |      0.251 |      0.189 |                 -0.062 |      211.000 |                         0.752 |
|               0.030 | ck4_p            |        12 |      0.251 |      0.188 |                 -0.063 |      147.000 |                         0.751 |
|               0.030 | ck4p_msp         |        12 |      0.205 |      0.154 |                 -0.051 |      222.000 |                         0.752 |
|               0.050 | ck4              |        12 |      0.455 |      0.305 |                 -0.150 |      136.000 |                         0.671 |
|               0.050 | ck4_msp          |        12 |      0.322 |      0.217 |                 -0.105 |      211.000 |                         0.673 |
|               0.050 | ck4_p            |        12 |      0.322 |      0.216 |                 -0.106 |      147.000 |                         0.671 |
|               0.050 | ck4p_msp         |        12 |      0.263 |      0.177 |                 -0.086 |      222.000 |                         0.673 |
