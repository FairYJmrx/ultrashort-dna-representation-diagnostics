...
\caption{Figure 1. Clean-perturbed feature stability across read length.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{figures/stage2\_fig\_hospital\_69\_75\_l2.png}
\caption{Figure 2. Hospital-like 69/75 bp perturbation drift.}
\end{figure}
...
\caption{Figure 3. Singleton property ablation.}
\end{figure}
...
\caption{Figure 4. Lightweight readout probes remained task-dependent.}
\end{figure}
...
\caption{Figure 5. Attention-style context visibility breakpoints.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{figures/stage2\_fig\_attention\_f1\_breakpoints.png}
\caption{Figure 6. Best readout transitions around motif visibility.}
\end{figure}
...
\caption{Figure 7. ARG/SNP boundary readout probes.}
\end{figure}
