...
| Shared-template length-continuity global rows | 76,440 | 420 shared source templates | every integer length 50-75 | NA | NA | 7 representations; 6 non-clean perturbations; shared-prefix design |
| Shared-template length-continuity local variants | 56,160 | 18,720 matched triplets | every integer length 50-75 | NA | NA | 180 triplets per length-by-mode cell; 4 local modes; grouped CV |
| ART Illumina matched pairs | 111,922 rows | 55,961 matched clean/simulated pairs | 50, 60, 69, 75, 100, 125, 150 | 6 | 21 | current-contract within-length simulator audit; not a causal length trend |
...
- The current manuscript reports read/template counts, label counts, genera/species counts and length grids in Methods and Table 2.
- The lower-range design is a dense shared-template sweep over 50-75 bp; 100, 125 and 150 bp are broader anchors, not a continuous 50-150 bp response curve.
