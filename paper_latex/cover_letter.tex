...
\href{mailto:ruixiangmei@link.cuhk.edu.cn}{ruixiangmei@link.cuhk.edu.cn}\\
...
The manuscript fits the journal's scope through its focus on reproducible sequence-representation methodology, quantitative benchmarking and public metagenomic resources. Source code, processed source tables, figure inputs and a manuscript-to-script map are maintained in an MIT-licensed versioned repository at \url{https://github.com/FairYJmrx/ultrashort-dna-representation-diagnostics}. The current five-author software and reproducibility snapshot is archived at \url{https://doi.org/10.5281/zenodo.22055051}; subsequent archived versions are linked by the Zenodo concept DOI \url{https://doi.org/10.5281/zenodo.21792340}.
