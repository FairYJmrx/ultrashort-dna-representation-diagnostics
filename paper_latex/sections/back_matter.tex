...
All processed data tables, figure source summaries and analysis outputs generated for this study are maintained in the versioned GitHub repository \href{https://github.com/FairYJmrx/ultrashort-dna-representation-diagnostics/tree/release}{ultrashort-dna-representation-diagnostics}, on the \texttt{release} branch. The frozen submission snapshot is GitHub Release \texttt{v1.1.1}; all archived versions are linked by the Zenodo concept DOI \href{https://doi.org/10.5281/zenodo.21792340}{doi:10.5281/zenodo.21792340}.
