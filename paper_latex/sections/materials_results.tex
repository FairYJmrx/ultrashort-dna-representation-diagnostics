...
Together, ART supports within-length simulator consistency, CAMI\_TOY\_low supports coarse fixed-head label retention, and CAMI II supports anonymous-read stability. The CAMI fixed-head tasks do not test fine taxonomic assignment, but they show that the controlled-grid pattern is not confined to one WGS-derived source or one target label.
