...
\toprule
\textbf{data layer} & \textbf{scale} & \textbf{diagnostic question} & \textbf{primary metrics} & \textbf{claim boundary} \\
\midrule
...
CAMI\_TOY\_low probes & 104,166-row initial subset and 216,000-row expanded subset; 30 candidate taxon identifiers; lengths 69,75,100 bp & Is coarse information readable in an external metagenomic source? & target/background macro-F1, accuracy & historical contextual probe; not a contract-v2 fine-label benchmark \\
