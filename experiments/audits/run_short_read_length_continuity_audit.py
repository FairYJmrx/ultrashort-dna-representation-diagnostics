...
def summarize_results(
    ...
    lines = [
        ...
        "",
        stability_summary[stability_summary["length"].isin([50, 60, 69, 75])].to_markdown(index=False, floatfmt=".4f"),
        "",
        "## Seven-block grouped local readout at 50, 60, 69 and 75 bp",
        "",
        readout_summary[readout_summary["length"].isin([50, 60, 69, 75])].to_markdown(index=False, floatfmt=".4f"),
        "",
