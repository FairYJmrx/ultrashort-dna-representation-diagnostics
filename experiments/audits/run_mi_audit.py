"""Organized entrypoint for `scripts.run_mi_audit`.

The implementation remains in `scripts/run_mi_audit.py` for import compatibility.
...
if __name__ == "__main__":
    runpy.run_module("scripts.run_mi_audit", run_name="__main__")
