...
def main() -> None:
    ...
    parser.add_argument("--representations", default="ckmer4_count_l2,ckmer4_property_l2,ckmer4_property_moment_l2,ckmer4_property_multiscale_mean_l2,ckmer4_property_multiscale_l2,ckmer4_property_anchor_l2,cspaced_property_l2,property_channels,rope_property")
