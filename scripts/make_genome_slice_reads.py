...
def default_genomes() -> list[tuple[str, Path]]:
    ...
    return [
        ("Aspergillus_fumigatus", root / "真菌界" / "Aspergillus" / "Aspergillus fumigatus" / "GCF_000002655.1_genomic.fna"),
        ("Candida_albicans", root / "真菌界" / "Candida" / "Candida albicans" / "GCF_000182965.3_genomic.fna"),
        ("Escherichia_coli_K12", root / "细菌界" / "Escherichia" / "Escherichia coli" / "GCF_000005845.2_genomic.fna"),
        ("Escherichia_coli_O157", root / "细菌界" / "Escherichia" / "Escherichia coli" / "GCF_000008865.2_genomic.fna"),
    ]
